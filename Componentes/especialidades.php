<div class="container">
    ...
    <div class="icon-grid">
        <div class="icon-item">
            <a href="blog.php">
                ...
                <div class="icon-caption">Adicciones</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-emoji-astonished" viewBox="0 0 16 16">
                ...
                <div class="icon-caption">Ansiedad</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <i class="fa-solid fa-triangle-exclamation"></i>
                <div class="icon-caption">Atención</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <i class="fas fa-heart"></i>
                <div class="icon-caption">Autoestima</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                ...
                <div class="icon-caption">Crianza</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <i class="fa-solid fa-battery-half"></i>
                <div class="icon-caption">Depresión</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <i class="fas fa-star"></i>
                <div class="icon-caption">Enfermedades
                    crónicas</div>
            </a>
        </div>
        <div class="icon-item">
  ...
  <path d="M4.285 12.433a.5.5 0 0 0 .683-.183A3.5 3.5 0 0 1 8 10.5c1.295 0 2.426.703 3.032 1.75a.5.5 0 0 0 .866-.5A4.5 4.5 0 0 0 8 9.5a4.5 4.5 0 0 0-3.898 2.25.5.5 0 0 0 .183.683M7 6.5C7 7.328 6.552 8 6 8s-1-.672-1-1.5S5.448 5 6 5s1 .672 1 1.5m4 0c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5S9.448 5 10 5s1 .672 1 1.5"/>
                ...
                <div class="icon-caption">Estrés</div>
            </a>
        </div>
        ...
        <div class="icon-item">
            <a href="blog.php">
                ...
                <div class="icon-caption">Impulsividad</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-square-fill" viewBox="0 0 16 16">
        ...
        <div class="icon-item">
            <a href="blog.php">
                ...
                <div class="icon-caption">Ira</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <i class="fa-solid fa-heart-crack"></i>
                <div class="icon-caption">Terapia de Pareja</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <i class="fa-solid fa-fire-flame-curved"></i>
                <div class="icon-caption">Sexualidad</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                ...
                <div class="icon-caption">Traumas</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-star-half" viewBox="0 0 16 16">
                    <path d="M5.354 5.119 7.538.792A.52.52 0 0 1 8 .5c.183 0 .366.097.465.292l2.184 4.327 4.898.696A.54.54 0 0 1 16 6.32a.55.55 0 0 1-.17.445l-3.523 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256a.5.5 0 0 1-.146.05c-.342.06-.668-.254-.6-.642l.83-4.73L.173 6.765a.55.55 0 0 1-.172-.403.6.6 0 0 1 .085-.302.51.51 0 0 1 .37-.245zM8 12.027a.5.5 0 0 1 .232.056l3.686 1.894-.694-3.957a.56.56 0 0 1 .162-.505l2.907-2.77-4.052-.576a.53.53 0 0 1-.393-.288L8.001 2.223 8 2.226z" />
                </svg>
                <div class="icon-caption">Riesgo suicida</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <i class="fas fa-star"></i>
                <div class="icon-caption">Sentido de vida</div>
            </a>
        </div>
        <div class="icon-item">
            <a href="blog.php">
                <i class="fas fa-comments"></i>
                <div class="icon-caption">Orientación
                    Vocacional</div>
            </a>
        </div>
        ...
        <div class="icon-item">
            <a href="blog.php">
                ...
                <div class="icon-caption">Problemas
                    de sueño</div>
            </a>
        </div>
        <div class="icon-item">
        ...
        <div class="icon-item">
            <a href="blog.php">
                ...
                <div class="icon-caption">Relaciones
                    Interpersonales</div>
            </a>
        </div>
    </div>
