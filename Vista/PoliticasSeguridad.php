          ...
          <section class="info-last">
            <div class="contenedor last-section">
              <div class="contenedor-textos-main">
                ...
                <p class="parrafo">Garantizamos la seguridad de toda la información que ingresa en Contigo Voy.Todos sus
                  datos están protegidos y almacenados disponibles en cualquier momento, incluso puede configurar
                  diferentes
                  niveles de acceso a la información para todos los miembros de su clínica o consultorio. Trabajamos para
                  garantizar que trabaje con total confidencialidad.</p>
