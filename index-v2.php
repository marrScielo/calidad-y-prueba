...
<head>
    ...
    <meta name="description"
        content="ContigoVoy ofrece apoyo emocional y psicológico con psicólogos profesionales en Perú. Terapia online y presencial para tu bienestar.">
...
<body>
    ...
    <main class="">
        <?php
        require_once __DIR__ . '/Controlador/ViewController.php';
        $viewController = new ViewController();
        $currentView = $viewController->getView();
